...
def main():
    ...
    def redraw_window():
        ...
        win.blit(p1_score_label, (0.2 * width, 10))
        win.blit(p2_score_label, (0.65 * width, 10))
        p1.draw(win)
        p2.draw(win)
        # pygame.display.flip()
    ...
    while run:
        ...
        # Bounce of left or right side of the window
...
def main_menu():
    ...
    while run:
        ...
        win.blit(main_title_label, (width / 2 - main_title_label.get_width() / 2, 200))
